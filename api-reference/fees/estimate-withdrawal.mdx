---
title: "Estimate Withdrawal Fees"
api: "POST /api/v1/fees/estimate/withdrawal"
description: "Preview the fees for a payout or cashout before creating it."
---
...
estimate = client.fees.estimate_withdrawal(amount=50, payment_method="mobile_money")
print(estimate["fee_breakdown"]["net_amount"])
```
...
const estimate = await client.fees.estimateWithdrawal({ amount: 50, paymentMethod: "mobile_money" });
console.log(estimate.fee_breakdown.net_amount);
```
